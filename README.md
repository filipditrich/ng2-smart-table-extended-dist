[![Build Status](https://travis-ci.org/akveo/ng2-smart-table-extended.svg?branch=master)](https://travis-ci.org/akveo/ng2-smart-table-extended)

# Angular Smart Table Component

ng2-smart-table-extended component made with :heart:  by [Akveo team](http://akveo.com/). Follow us on [Twitter](https://twitter.com/akveo_inc) to get latest news about this component first!

### Demo

<a target="_blank" href="https://akveo.github.io/ng2-smart-table-extended/">Live Demo</a>
...
Let's register <i>settings</i> property inside of the component where we want to have the table and configure some columns [Settings documentation](https://akveo.github.io/ng2-smart-table-extended/#/documentation):
...
Finally let's put the ng2-smart-table-extended component inside of the template:
...
Installation, customization and other useful articles: https://akveo.github.io/ng2-smart-table-extended/
